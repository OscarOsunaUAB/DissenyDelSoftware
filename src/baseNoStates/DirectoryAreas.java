...
public final class DirectoryAreas extends Observable {
   ...
   *
   * @return the unique DirectoryAreas instance
   */
   ...
   * @param from the space where the door starts
   * @param to the space where the door leads
   * @throws IllegalStateException if the door is not found
   */
